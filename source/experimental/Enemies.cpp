...
void Enemies::mapIterate(Reference_Files aRF, Add_Game& aGame, string aDecision, std::mt19937 aGen, string nextDecision, string mainDecision, string statDecision, string balDecision) {
    ...
    if (nextDecision == "Y") {
        for (int i = 0; i < aRF.getEneZones().size(); i++) {
            ...
            for (int e = 0; e < ene_count; e++) {
                if (cur_zone != "ZONE031.ZND" && cur_zone != "ZONE025.ZND") {
                    if (cur_zone == "ZONE013.ZND" && e == 0) {
                        e = 1;
                        wep_pos += 1124;
                        ene_off += 8;
                    }
                    else if (cur_zone == "ZONE009.ZND" && e == 6) {
                        e = 7;
                        wep_pos += 1124;
                        ene_off += 8;
                    }
                    ...
                    else if (cur_zone == "ZONE011.ZND" && e == 0) {
                        e = 1;
                        wep_pos += 1124;
                        ene_off += 8;
                    }
                    ...
                    else if (cur_zone == "ZONE051.ZND" && e == 1) {
                        e += 1;
                        wep_pos += 1124;
                        ene_off += 8;
                    }
                    ...
                    else if (cur_zone == "ZONE048.ZND" && (e == 0 || e == 3 || e == 5 || e == 23)) {
                        e += 1;
                        wep_pos += 1124;
                        ene_off += 8;
                    }
                    ...
                    else if (cur_zone == "ZONE053.ZND" && (e == 0 || e == 1 || e == 2)) {
                        if (e == 0) {
                            e += 3;
                            wep_pos += (1124 * 3);
                            ene_off += 24;
                    ...
                    else if (cur_zone == "ZONE022.ZND" && e == 0) {
                        ene_count = 2;
                    }
    ...
    if (statDecision == "Y") {
        ...
        if (balDecision == "Y") {
            ...
            dist_20 = std::uniform_int_distribution<>(1, 255);
            ...
            for (int e = 0; e < ene_count; e++) {
                ...
                for (int i = 0; i < 5; i++) {
                    if (i == 0 || i == 1) {
                        ...
                        stat = ene_hp_stat / (100 / 75);
                    }
                    else if (i == 4) {
                        stat = ene_hp_stat / (100 / 60);
                    }
                    sprintf_s(rand_hp, "%X", stat);
                    ss_rand_hp << rand_hp;
                    ss_rand_hp >> s_rand_hp;
