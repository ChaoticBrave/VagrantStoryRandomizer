...
int main() {
    ...
    cout << "============================" << endl;
    cout << "WARNING:" << endl;
    cout << "The room randomizer is still in a very early state. Most randomized room combinations will crash the game. Use at your own risk and BACKUP YOUR BIN/CUE BEFORE USING IT!" << endl;
    cout << "============================" << endl;
    ...
    while (decision_r != "Y" && decision_r != "N") {
        decision_r = "";
        cout << "Would you like to randomize rooms? (Y/N)" << endl;
